...
If the database won't connect, make sure MySQL is actually running and you have the right password in the config file. If prices aren't showing, check that you imported the product data SQL file. If something weird happens with logins, just clear your browser cookies and restart Apache.

That should cover everything you need to get your shop running smoothly!
